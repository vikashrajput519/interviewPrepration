...
public class RunAsyncDemo {
    ...
    public Void saveEmployees(File jsonFile) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> runAsyncFuture = CompletableFuture.runAsync(new Runnable() {
            ...
            public void run() {
                try {
                    List<Employee> employees = mapper.readValue(jsonFile, new TypeReference<Object>() {
                            });
    ...
    public Void saveEmployeesByLambda(File jsonFile) throws ExecutionException, InterruptedException {
        ObjectMapper mapper = new ObjectMapper();
